...
import org.cyanogenmod.internal.hardware.ICMHardwareServiceProvider;
...
public class CMHardwareService extends Service implements ThermalUpdateCallback {

    private static final String TAG = "CMHardwareServiceBroker";
    ...
    private final IBinder mBinder = new ICMHardwareServiceProvider.Stub() {
